...
| Home and service navbar | The v11 navigation check passes Home, five Settings services, nested Bluetooth pairing, Overview, notifications, Quick Settings and tile editing. Back pops nested pages and disappears on Home; logo, clock and gear keep their bounds. Visual inspection confirms the reference logo, full weekday/24-hour clock and gear on Home and Connected devices, with Back added beside the logo on the service page. |
