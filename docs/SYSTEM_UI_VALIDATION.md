...
| Native notifications | A v3 cold boot with keyguard disabled leaves notification rows at zero size. Opening keyguard once initializes them. The startup initialization fix is pending rebuilt-image verification. |
